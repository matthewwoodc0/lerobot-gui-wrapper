...
def run_compat_mode(config: dict[str, Any], *, json_output: bool = False, refresh: bool = False) -> int:
    ...
    print(f"- Python compatibility: {capabilities.python_compatibility_status} ({capabilities.python_compatibility_detail})")
...
def parse_args() -> argparse.Namespace:
    ...
    subparsers.add_parser("gui", help="Launch the Qt desktop GUI.")
    subparsers.add_parser("gui-qt", help="Launch the Qt desktop GUI (legacy alias).")
