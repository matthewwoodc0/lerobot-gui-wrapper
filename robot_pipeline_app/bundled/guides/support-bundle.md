...
```bash
lerobot-pipeline-manager support-bundle --run-id latest --output ./support-bundle-latest.zip
```

Generate a bundle for a specific run id:

```bash
lerobot-pipeline-manager support-bundle --run-id deploy_20260304_120011 --output ./support-bundle-deploy.zip
```
