...
Activate your LeRobot environment, then launch the installed command:
...
If the app does not start, see the platform-specific steps in [README.md](../README.md#platform-setup) for xcb/Qt errors on Linux.
