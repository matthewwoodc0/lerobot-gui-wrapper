...
class QtExperimentsPage(_PageWithOutput):
    def __init__(
        ...
        *,
        ...
        sim_eval_form.addWidget(QLabel("Env type"), 0, 0)
        ...
        sim_eval_form.addWidget(QLabel("Task"), 0, 2)
        ...
        sim_eval_form.addWidget(QLabel("Benchmark"), 1, 0)
        ...
        sim_eval_form.addWidget(QLabel("Episodes"), 1, 2)
        ...
        sim_eval_form.addWidget(QLabel("Batch size"), 2, 0)
        ...
        sim_eval_form.addWidget(QLabel("Seed"), 2, 2)
        ...
        sim_eval_form.addWidget(QLabel("Device"), 3, 0)
        ...
        sim_eval_form.addWidget(QLabel("Output dir"), 3, 2)
        ...
        sim_eval_form.addWidget(QLabel("Job name"), 4, 0)
        ...
        sim_eval_form.addWidget(QLabel("Custom args"), 4, 2)
